...
def printer(results, round):
    ...
    print('A: {} +- {}'.format(results[26][0], results[26][1]))
    print('B: {} +- {}'.format(results[27][0], results[27][1]))
    print('C: {} +- {}'.format(results[28][0], results[28][1]))
    print('D: {} +- {}'.format(results[29][0], results[29][1]))
    print('IDS: {} +- {}'.format(results[30][0], results[30][1]))
